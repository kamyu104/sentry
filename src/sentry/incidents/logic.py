...
def update_alert_rule_trigger_action(
    trigger_action, type=None, target_type=None, target_identifier=None, integration=None, sentry_app=None
):
    """
    ...
    :param integration: (Optional) The Integration related to this action.
    :param sentry_app: (Optional) The Integration related to this action.
    :return:
    """
    updated_fields = {}
    if type is not None:
